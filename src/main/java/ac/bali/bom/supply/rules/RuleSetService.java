...
public interface RuleSetService
{
    ...
    void create(String name, Supplier supplier, List<SupplyRule> rules);
    ...
    class Mixin implements RuleSetService
    {
        ...
        @Override
        public void create(String name, Supplier supplier, List<SupplyRule> rules)
        {
            ...
            instance.supplier().set(supplier);
