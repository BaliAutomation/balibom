...
public class Main extends Application
{
    ...
    public void start(Stage stage) throws Exception
    {
        ...
        EntityPane<SupplierOrder> ordersPane = objectFactory.newObject(EntityPane.class, SupplierOrder.class, "Orders");
        ...
        EntityPane<SupplyRule> rulesPane = objectFactory.newObject(EntityPane.class, SupplyRule.class, "Rules");
