...
import ac.bali.bom.ui.support.Ignore;
import ac.bali.bom.ui.support.MemberOrderComparator;
...
{
    static final MemberOrderComparator MEMBER_COMPARATOR = new MemberOrderComparator();
